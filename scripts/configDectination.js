...
async function automateDectinations() {
    console.log("\x1b[34m", "[destination script] Automating destination. It may take a while.");
    try {
        ...
        console.log("\x1b[32m", "[destination script] destination Automated Successfully.");
        process.exit(0);
    } catch (_) {
        console.log("\x1b[31m", "[destination script] Error while automating destination.");
        console.log(_);
        process.exit(1);
    }
}
